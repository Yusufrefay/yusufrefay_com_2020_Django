...
#MEDIA_ROOT =  os.path.join(BASE_DIR, '/home/ubuntu/yusufrefay_com_2020_Django/media') 

#Local Command line

MEDIA_ROOT = os.path.join(BASE_DIR,'media')

#We need to check this if we need to move the media folder from under'yusufrefay_com_2020' directory to the root directory like the static files!
